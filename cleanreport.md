...
1. **Wave B** — server catalog, lazy framer-motion, pagination  
2. Optional: wire `AnnouncementBar` into shell *or* leave deleted (CMS announcement already covers top bar)  
