...
export const STOREFRONT_THEME_PRESETS: StorefrontThemePreset[] = [
  ...
  },
  {
    id: 'party-pop',
    label: 'Party Pop',
    description: 'Rose, candy pink, and royal blue - playful party supplies and gifts.',
    inspiration: 'ThePartyStore client onboarding',
    tags: ['light', 'party', 'retail', 'bold'],
    theme: {
      presetId: 'party-pop',
      primaryColor: '#E11D48',
      accentColor: '#2563EB',
      ...
      heroStyle: 'bold',
      heroGradient:
        'radial-gradient(ellipse at 20% 0%, rgba(225,29,72,0.16) 0%, transparent 55%), radial-gradient(ellipse at 95% 20%, rgba(37,99,235,0.14) 0%, transparent 45%), linear-gradient(180deg, #FFF1F2 0%, #FFFFFF 100%)',
      cardStyle: 'elevated',
      colorScheme: 'light',
    },
    heroCopy: {
