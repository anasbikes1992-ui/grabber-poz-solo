...
export const STOREFRONT_THEME_PRESETS: StorefrontThemePreset[] = [
  ...
  {
    id: 'vibe',
    label: 'Vibe Editorial Black',
    description: 'Premium fashion/lifestyle direction with black chrome, crisp cards, and editorial contrast.',
    inspiration: 'Clean-room fashion storefront patterns',
    tags: ['fashion', 'lifestyle', 'editorial', 'dark-header'],
    theme: {
      presetId: 'vibe',
      primaryColor: '#0A0A0A',
      accentColor: '#BE185D',
      ...
      heroStyle: 'cinematic',
      heroGradient:
        'linear-gradient(180deg, rgba(10,10,10,0.08) 0%, rgba(250,250,250,0.92) 62%), radial-gradient(ellipse at 88% 12%, rgba(190,24,93,0.14) 0%, transparent 45%)',
      cardStyle: 'flat',
      colorScheme: 'light',
      interactiveFx: 'none',
      carouselEffect: 'ken-burns',
      tickerText: 'NEW ARRIVALS - LIVE STOCK - COD DELIVERY - CURATED STYLE DROPS',
    },
    heroCopy: {
      title: 'Curated drops, live from store',
      subtitle: 'A polished fashion and lifestyle catalog with live stock, clean cards, and confident editorial merchandising.',
  ...
  },
  {
    id: 'ocean',
    label: 'Ocean Charge',
    description: 'Cool aqua lifestyle preset for beverage, wellness, and coastal brand demos.',
    inspiration: 'Clean-room lifestyle beverage storefront patterns',
    tags: ['energy', 'beverage', 'lifestyle', 'aqua'],
    theme: {
      presetId: 'ocean',
      primaryColor: '#075985',
      accentColor: '#0D9488',
      ...
      heroStyle: 'bold',
      heroGradient:
        'radial-gradient(ellipse at 20% 0%, rgba(13,148,136,0.18) 0%, transparent 52%), radial-gradient(ellipse at 92% 12%, rgba(14,165,233,0.20) 0%, transparent 48%), linear-gradient(180deg, #F0FDFA 0%, #FFFFFF 70%)',
      cardStyle: 'elevated',
      colorScheme: 'light',
      interactiveFx: 'ticker',
      carouselEffect: 'parallax-wave',
      tickerText: 'COLD DROPS - CASE DEALS - STORE PICKUP - LIVE INVENTORY',
    },
    heroCopy: {
      title: 'Fuel the next run',
      subtitle: 'A brand-first demo for beverages, lifestyle retail, bundles, cases, and fast-moving campaign drops.',
